...
public class Main {
    public static void main(String[] args) {
        ...
        //checks if player object is in list, uses parameters, no comparison function
        boolean contains = playerList.contains(new Player(1, "Ela", 67));
        System.out.println("\nList has Ela? " + contains);

        //finds the index of a specific element
        int index = playerList.indexOf(new Player(1, "Ela", 67));
        System.out.println("Index of Ela? " + index);
    }
}